...
sequenceDiagram
    ...
    alt needs connection (list without -f, add without -f, check, reload)
...
[List](sequence-list.md) · [Add](sequence-add.md) · [Check](sequence-check.md) · [Reload](sequence-reload.md)
